 ...
 */
JNIEXPORT void JNICALL Java_org_sipdroid_media_NativeWrapper_ncleanupLib(JNIEnv* env, jobject this)
{
	mpg123_delete(mh);
	mpg123_exit();
	mh = NULL;
 ...
 */
JNIEXPORT jstring JNICALL Java_org_sipdroid_media_NativeWrapper_ngetError(JNIEnv* env, jobject this)
{
 ...
 * Init one MP3 file
 */
JNIEXPORT jint JNICALL Java_org_sipdroid_media_NativeWrapper_ninitMP3(JNIEnv* env, jobject this, jstring filename)
{
	jint err = MPG123_ERR;
 ...
 */
void Java_org_sipdroid_media_NativeWrapper_ncleanupMP3(JNIEnv* env, jobject this)
{
	mpg123_close(mh);
}
 ...
 *
 */
JNIEXPORT jboolean JNICALL Java_org_sipdroid_media_NativeWrapper_nsetEQ(JNIEnv* env, jobject this, jint ch, jdouble val)
{
 ...
 *
 */
JNIEXPORT void JNICALL Java_org_sipdroid_media_NativeWrapper_nresetEQ(JNIEnv* env, jobject this)
{
	mpg123_reset_eq(mh);
}
 ...
 */
JNIEXPORT jobject JNICALL Java_org_sipdroid_media_NativeWrapper_ngetAudioInformations(JNIEnv* env, jobject this, jclass clazz)
{
  	// Get our class defined in java project
	clazz = (*env)->FindClass(env, "org/sipdroid/media/AudioFileInformations");
	if (clazz == 0)
		return NULL;
 ...
 * Decode our MP3 file
 */
JNIEXPORT jint JNICALL Java_org_sipdroid_media_NativeWrapper_ndecodeMP3(JNIEnv* env, jobject this, jint inlen, jshortArray jpcm)
{
	jint err = MPG123_ERR;
	jint outlen = 0;
	jshort *pcm = NULL;
 ...
 */
JNIEXPORT void JNICALL Java_org_sipdroid_media_NativeWrapper_nseekTo(JNIEnv* env, jobject this, jint pos)
{
	if(mh != NULL)
